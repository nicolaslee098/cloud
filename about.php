			...
			<body class="aboutbg">
				...
				<div class="split right">
				  <div class="centered">
				    ...
				    <p>s3827507[at]student.rmit.edu.au</p>
				  </div>
				</div>
